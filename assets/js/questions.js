questions = [
	{
	question: "Which answer correctly creates an array?",
	choices: ["array=(0,1,2,)", "array=[0,1,2]", "array={0,1,2}"],
	answer: "array=[0,1,2]",
	},
	{
	question: "Which of the following is not a means of declaring a variable?",
	choices: ["dec = 'variable'", "let = 'variable'", "const = 'variable'"],
	answer: "dec = 'variable'",
	},
	{
